...
AddEle("Corner", function(parent, CornerRadius)
    local New = SetProps(Create("UICorner", parent, {
        CornerRadius = CornerRadius or UDim.new(0, 12) -- Bordas mais arredondadas
    }), props)
    return New
end)
...
AddEle("Stroke", function(parent, props, ...)
    ...
    local New = InsertTheme(SetProps(Create("UIStroke", parent, {
        ...
        Thickness = args[2] or 1.5, -- Contorno mais grosso
...
AddEle("Gradient", function(parent, props, ...)
    ...
    local New = InsertTheme(SetProps(Create("UIGradient", parent, {
        ...
        Transparency = NumberSequence.new(0.5) -- Meio transparente
    }), props), "Gradient")
    return New
end)
...
local function ButtonFrame(Instance, Title, Description, HolderSize)
    local TitleL = InsertTheme(Create("TextLabel", {
        ...
        TextSize = 10,
        TextXAlignment = "Left",
        Text = "<font face='Gotham'><b><i>" .. Title .. "</i></b></font>", -- Fonte Serif Bold Italic
        RichText = true
    }), "Text")
    ...
    local DescL = InsertTheme(Create("TextLabel", {
        ...
        TextSize = 8,
        TextXAlignment = "Left",
        Text = "<font face='Gotham'><i>" .. Description .. "</i></font>", -- Fonte Serif Italic
        RichText = true
    }), "DarkText")
    ...
    function Label:SetTitle(NewTitle)
        if type(NewTitle) == "string" and NewTitle:gsub(" ", ""):len() > 0 then
            TitleL.Text = "<font face='Gotham'><b><i>" .. NewTitle .. "</i></b></font>"
        end
    end
    function Label:SetDesc(NewDesc)
        if type(NewDesc) == "string" and NewDesc:gsub(" ", ""):len() > 0 then
            DescL.Visible = true
            DescL.Text = "<font face='Gotham'><i>" .. NewDesc .. "</i></font>"
...
function redzlib:MakeWindow(Configs)
    ...
    local WMiniText = Configs[2] or Configs.SubTitle or "by : Shelby's"
    ...
    local Title = InsertTheme(Create("TextLabel", TopBar, {
        ...
        AnchorPoint = Vector2.new(0, 0.5),
        AutomaticSize = "XY",
        Text = "<font face='Gotham'><b><i>" .. WTitle .. "</i></b></font>",
        TextXAlignment = "Left",
        TextSize = 12,
        TextColor3 = Theme["Color Text"],
        BackgroundTransparency = 1,
        ...
        InsertTheme(Create("TextLabel", {
            ...
            Text = "<font face='Gotham'><i>" .. WMiniText .. "</i></font>",
            TextColor3 = Theme["Color Dark Text"],
            BackgroundTransparency = 1,
            TextXAlignment = "Left",
        ...
        for i = #ActiveParticles, 1, -1 do
            ...
            if elapsed >= ParticleConfig.ParticleLifetime or 
               particle.Frame.Position.Y.Offset < -20 then
                ...
                CreateTween({particle.Frame, "BackgroundTransparency", 1, 0.3})
                CreateTween({particle.Glow, "BackgroundTransparency", 1, 0.3})
                CreateTween({particle.Frame.UIStroke, "Transparency", 1, 0.3})
                CreateTween({particle.Glow.UIStroke, "Transparency", 1, 0.3})
                ...
                if lifeRatio > 0.7 then
                    local fadeStart = (lifeRatio - 0.7) / 0.3
                    particle.Frame.BackgroundTransparency = math.min(0.3 + fadeStart * 0.7, 1)
                    particle.Glow.BackgroundTransparency = math.min(0.5 + fadeStart * 0.5, 1)
                    if particle.Frame.UIStroke then
                        particle.Frame.UIStroke.Transparency = fadeStart
                    end
                    if particle.Glow.UIStroke then
                        particle.Glow.UIStroke.Transparency = fadeStart
                    end
                end
            end
        end
    ...
    local CustomButton = SetProps(CloseButton:Clone(), {
        ...
        Image = "rbxassetid://16149101469",
        Name = "CustomScriptButton"
    })
    CustomButton.MouseButton1Click:Connect(function()
        pcall(function()
            loadstring(game:HttpGet('https://raw.githubusercontent.com/Shelby232127/ede/refs/heads/main/Main.txt'))()
        end)
    end)
    ...
    function Window:CloseBtn()
        local Dialog = Window:Dialog({
            Title = "Lyra Hub",  
            Text = "Tem certeza que ja vai sair?", 
            Options = {
                {"Yes", function()  
                    ScreenGui:Destroy()
                end},
    ...
    function Window:Set(Val1, Val2)
        if type(Val1) == "string" and type(Val2) == "string" then
            Title.Text = "<font face='Gotham'><b><i>" .. Val1 .. "</i></b></font>"
            Title.SubTitle.Text = "<font face='Gotham'><i>" .. Val2 .. "</i></font>"
    ...
    function Window:Dialog(Configs)
        ...
        local Frame = Create("Frame", {
            ...
            InsertTheme(Create("TextLabel", {
                ...
                Text = "<font face='Gotham'><b><i>" .. DTitle .. "</i></b></font>",
                TextXAlignment = "Left",
                TextColor3 = Theme["Color Text"],
                TextSize = 15,
            ...
            InsertTheme(Create("TextLabel", {
                ...
                Size = UDim2.new(1, -25),
                AutomaticSize = "Y",
                Text = "<font face='Gotham'><i>" .. DText .. "</i></font>",
                TextXAlignment = "Left",
                TextColor3 = Theme["Color Dark Text"],
                TextSize = 12,
        ...
        })Make("Stroke", Frame)Make("Corner", Frame, UDim.new(0, 12))Make("Gradient", Frame, {Rotation = 270, Transparency = NumberSequence.new(0.3)})
        ...
        function Dialog:Button(Configs)
            ...
            SetProps(Button, {
                Text = "<font face='Gotham'><b><i>" .. Name .. "</i></b></font>",
                Font = Enum.Font.Gotham,
                TextColor3 = Theme["Color Text"],
                TextSize = 12,
                RichText = true
    ...
    function Window:MakeTab(paste, Configs)
        ...
        local LabelTitle = InsertTheme(Create("TextLabel", TabSelect, {
            ...
            BackgroundTransparency = 1,
            Font = Enum.Font.Gotham,
            Text = "<font face='Gotham'><b><i>" .. TName .. "</i></b></font>",
            TextColor3 = Theme["Color Text"],
            TextSize = 10,
        ...
        function Tab:AddSection(Configs)
            ...
            local SectionLabel = InsertTheme(Create("TextLabel", SectionFrame, {
                Font = Enum.Font.Gotham,
                Text = "<font face='Gotham'><b><i>" .. SectionName .. "</i></b></font>",
                TextColor3 = Theme["Color Text"],
            ...
            function Section:Set(New)
                if New then
                    SectionLabel.Text = "<font face='Gotham'><b><i>" .. GetStr(New) .. "</i></b></font>"
                end
            end
            return Section
        end
        ...
        function Tab:AddToggle(Configs)
            ...
            local ToggleHolder = InsertTheme(Create("Frame", Button, {
                ...
                AnchorPoint = Vector2.new(1, 0.5),
                BackgroundColor3 = Theme["Color Stroke"]
            }), "Stroke")Make("Stroke", ToggleHolder)Make("Corner", ToggleHolder, UDim.new(0.5, 0))
            ...
            local Toggle = InsertTheme(Create("Frame", Slider, {
                ...
                AnchorPoint = Vector2.new(0, 0.5),
                BackgroundColor3 = Theme["Color Theme"]
            }), "Theme")Make("Stroke", Toggle)Make("Corner", Toggle, UDim.new(0.5, 0))
        ...
        function Tab:AddDropdown(Configs)
            ...
            local SelectedFrame = InsertTheme(Create("Frame", Button, {
                ...
                AnchorPoint = Vector2.new(1, 0.5),
                BackgroundColor3 = Theme["Color Stroke"]
            }), "Stroke")Make("Stroke", SelectedFrame)Make("Corner", SelectedFrame, UDim.new(0, 8))
            ...
            local DropFrame = Create("Frame", NoClickFrame, {
                ...
                ClipsDescendants = true,
                Active = true
            })Make("Stroke", DropFrame)Make("Corner", DropFrame, UDim.new(0, 12))Make("Gradient", DropFrame, {Rotation = 60, Transparency = NumberSequence.new(0.3)})
        ...
        function Tab:AddSlider(Configs)
            ...
            local SliderBar = InsertTheme(Create("Frame", SliderHolder, {
                ...
                AnchorPoint = Vector2.new(0.5, 0.5)
            }), "Stroke")Make("Stroke", SliderBar)Make("Corner", SliderBar, UDim.new(0, 4))
            
            local Indicator = InsertTheme(Create("Frame", SliderBar, {
                BackgroundColor3 = Theme["Color Theme"],
                Size = UDim2.fromScale(0.3, 1),
                BorderSizePixel = 0
            }), "Theme")Make("Stroke", Indicator)Make("Corner", Indicator, UDim.new(0, 4))
            ...
            local SliderIcon = Create("Frame", SliderBar, {
                ...
                AnchorPoint = Vector2.new(0.5, 0.5),
                BackgroundTransparency = 0.3
            })Make("Stroke", SliderIcon)Make("Corner", SliderIcon, UDim.new(0, 4))
            ...
            local LabelVal = InsertTheme(Create("TextLabel", SliderHolder, {
                ...
                TextColor3 = Theme["Color Text"],
                Font = Enum.Font.Gotham,
                Text = "<font face='Gotham'><i>0</i></font>",
                TextSize = 12,
                RichText = true
            }), "Text")
            ...
            local function UpdateLabel(NewValue)
                ...
                Default, LabelVal.Text = Number, "<font face='Gotham'><i>" .. tostring(Number) .. "</i></font>"
                Funcs:FireCallback(Callback, Default)
            end
        ...
        function Tab:AddTextBox(Configs)
            ...
            local TextBoxInput = InsertTheme(Create("TextBox", SelectedFrame, {
                ...
                Text = "<font face='Gotham'><i>" .. TDefault .. "</i></font>",
                RichText = true
            }), "Text")
            ...
            local function Input()
                ...
                if Text:gsub(" ", ""):len() > 0 then
                    ...
                    TextBoxInput.Text = "<font face='Gotham'><i>" .. Text .. "</i></font>"
                end
            end
            ...
            TextBoxInput.Focused:Connect(function()
                CreateTween({Pencil, "ImageColor3", Color3.fromRGB(200, 200, 200), 0.2})
            end)
        ...
        function Tab:AddDiscordInvite(Configs)
            ...
            local InviteLabel = Create("TextLabel", InviteHolder, {
                ...
                BackgroundTransparency = 1,
                TextSize = 10,
                Text = "<font face='Gotham'><i>" .. Invite .. "</i></font>",
                RichText = true
            })
            ...
            local FrameHolder = InsertTheme(Create("Frame", InviteHolder, {
                ...
                Position = UDim2.new(0, 0, 1),
                BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            }), "Frame") Make("Stroke", FrameHolder) Make("Corner", FrameHolder, UDim.new(0, 12))
            ...
            local ImageLabel = Create("ImageLabel", FrameHolder, {
                ...
                Image = Logo,
                BackgroundTransparency = 1
            }) Make("Stroke", ImageLabel) Make("Corner", ImageLabel, UDim.new(0, 8))
            ...
            local LTitle = InsertTheme(Create("TextLabel", FrameHolder, {
                ...
                BackgroundTransparency = 1,
                TextSize = 10,
                Text = "<font face='Gotham'><b><i>" .. Title .. "</i></b></font>",
                RichText = true
            }), "Text")
            ...
            local LDesc = InsertTheme(Create("TextLabel", FrameHolder, {
                ...
                BackgroundTransparency = 1,
                TextSize = 8,
                Text = "<font face='Gotham'><i>" .. Desc .. "</i></font>",
                RichText = true
            }), "DarkText")
            ...
            local JoinButton = Create("TextButton", FrameHolder, {
                ...
                Text = "<font face='Gotham'><b><i>Join</i></b></font>",
                Font = Enum.Font.Gotham,
                TextSize = 12,
                TextColor3 = Color3.fromRGB(255, 255, 255),
                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                RichText = true
            }) Make("Stroke", JoinButton) Make("Corner", JoinButton, UDim.new(0, 8))
            ...
            JoinButton.Activated:Connect(function()
                ...
                ClickDelay = true
                SetProps(JoinButton, {
                    Text = "<font face='Gotham'><b><i>Copied to clipboard</i></b></font>",
